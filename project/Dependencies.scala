...
object Dependencies {
  ...
  lazy val akka       = ("com.typesafe.akka" %% "akka-actor-typed" % "2.6.16").cross(CrossVersion.for3Use2_13)
  lazy val akkaHttp   = ("com.typesafe.akka" %% "akka-http"        % "10.2.6").cross(CrossVersion.for3Use2_13)
  lazy val akkaStream = ("com.typesafe.akka" %% "akka-stream"      % "2.6.16").cross(CrossVersion.for3Use2_13)
  ...
  lazy val finatraHttp = ("com.twitter" %% "finatra-http-server" % "21.8.0").cross(CrossVersion.for3Use2_13)

  private val helidonVersion = "2.3.3"
  ...
  lazy val javalin = "io.javalin" % "javalin" % "4.0.0"
  ...
  lazy val vertxWeb = "io.vertx" % "vertx-web" % "4.1.3"
